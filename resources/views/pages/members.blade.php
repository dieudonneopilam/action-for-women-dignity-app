...
@section('main')
    <div class="members">
        @isset(auth()->user()->isadmin)
           @if(auth()->user()->isadmin == 1 and auth()->user()->ismemberadmin == 1)
            <div class="card-user">
        ...
        <div class="card-member">
           ...
           <span class="menu-options">
               ...
               <svg class="close-point" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
           ...
           @endisset
            ...
            <div class="identite">
                ...
                <p class="social-media">
                    <span class="fb">
                        <a href="">
                            <svg color=blue xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                    ...
                    <span class="twt">
                        <a href="">
                            <svg color=blue xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                    ...
                    <span class="wht">
                        <a href="">
                            <svg color=green xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
